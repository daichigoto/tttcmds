...
%token	<i>	SUB GSUB 
%token	<i>	SSVSTR2STR V2S STR2SSVSTR S2V	/* ONGS Inc. */
%token	<i>	IF INDEX LSUBSTR MATCHFCN NEXT NEXTFILE
...
%left	GSUB 
%left	SSVSTR2STR V2S STR2SSVSTR S2V	/* ONGS Inc. */
%left	IF INDEX LSUBSTR MATCHFCN NEXT NUMBER
...
term:
	...
	| SUBSTR '(' pattern comma pattern ')'
		{ $$ = op3(SUBSTR, $3, $5, NIL); }
	| SSVSTR2STR '(' pattern ')'		/* ONGS Inc. */
		{ $$ = op1(SSVSTR2STR, $3); }
	| V2S '(' pattern ')'			/* ONGS Inc. */
		{ $$ = op1(SSVSTR2STR, $3); }
	| STR2SSVSTR '(' pattern ')'		/* ONGS Inc. */
		{ $$ = op1(STR2SSVSTR, $3); }
	| S2V '(' pattern ')'			/* ONGS Inc. */
		{ $$ = op1(STR2SSVSTR, $3); }
	| var
	;
