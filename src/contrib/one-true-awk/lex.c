...
Keyword keywords[] ={	/* keep sorted: binary searched */
	...
	{ "s2v",	STR2SSVSTR,	STR2SSVSTR },	/* ONGS Inc. */
	{ "sin",	FSIN,		BLTIN },
	{ "split",	SPLIT,		SPLIT },
	{ "sprintf",	SPRINTF,	SPRINTF },
	{ "sqrt",	FSQRT,		BLTIN },
	{ "srand",	FSRAND,		BLTIN },
	{ "ssvstr2str",	SSVSTR2STR,	SSVSTR2STR },	/* ONGS Inc. */
	{ "str2ssvstr",	STR2SSVSTR,	STR2SSVSTR },	/* ONGS Inc. */
	{ "sub",	SUB,		SUB },
	{ "substr",	SUBSTR,		SUBSTR },
	{ "system",	FSYSTEM,	BLTIN },
	{ "tolower",	FTOLOWER,	BLTIN },
	{ "toupper",	FTOUPPER,	BLTIN },
	{ "v2s",	SSVSTR2STR,	SSVSTR2STR },	/* ONGS Inc. */
	{ "while",	WHILE,		WHILE },
};
