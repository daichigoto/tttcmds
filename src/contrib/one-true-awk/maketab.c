...
{	int token;
	...
	{ SSVSTR2STR, "owk_ssvstr2str", "ssvstr2str" },	/* ONGS Inc. */
	{ V2S, "owk_ssvstr2str", "v2s" },		/* ONGS Inc. */
	{ STR2SSVSTR, "owk_str2ssvstr", "str2ssvstr" },	/* ONGS Inc. */
	{ S2V, "owk_str2ssvstr", "s2v" },		/* ONGS Inc. */
	{ SUB, "sub", "sub" },
	{ GSUB, "gsub", "gsub" },
	{ INDEX, "sindex", "sindex" },
